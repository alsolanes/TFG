...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--enable-unicode=ucs4' '--prefix=/opt/anaconda1anaconda2anaconda3' 'CC=gcc'",
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=-------src-dir-------/Python-2.7.9',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=-------src-dir-------/Python-2.7.9 ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
